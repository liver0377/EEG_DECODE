...
def get_eeg_features(sub, eeg_model, dataloader, device, train=True):
    ...
    eeg_features_path = f"/home/tom/fsas/eeg_data/text/ATM_S_eeg_features_{sub}_{'train' if train else 'test'}.pt"
...
if __name__ == "__main__":
    ...
    eeg_encoder_ckpt_path = "/home/tom/projects/EEG_DECODE/Retrieval/models/contrast/ATMS/sub-08/04-25_21-56/40.pth"
